...
def run_program():
    ...
    if 1 in stage:    
        ...
        log_text_22 = f'• Nejbližší Planned available PZN105 alespoň 0 přidáno do výstupu . . .\n'         
        ...
        log_text_23 = f'• Nejbližší Planned available PZN100 alespoň 0 přidáno do výstupu . . .\n'         
        ...
        log_text_24 = f'• Info zda možno převést přidáno do výstupu . . .\n'         
        ...
        log_text_25 = f'• Záhlaví přidáno do výstupu . . .\n'         
